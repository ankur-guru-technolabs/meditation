            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-capitalize pl-3">Feedback table</h6>
                    </div>
                </div>
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive px-3">
                        <table class="table table-bordered table-hover display" id="feedback_list_table">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="" data-toggle="modal" data-target="#feedbackModal" data-id="{{$feedback->id}}" data-name="{{$feedback->name}}" data-email="{{$feedback->email}}" data-description="{{$feedback->description}}">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    </td>
                                </tr>
